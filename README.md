# SQL-project
Tital:- Social Media Advertising Analysis
...
1.Analyze campaign performance using SQL.

2.Measure impressions and clicks.

3.Calculate CTR and ROI
.
4.Identify top-performing ads.

5.Support data-driven marketing decisions.

6.Shows which user interacted with which ad under which campaign.

7.Compare Age Group Performance.
...
3.Metrics like CTR and CPC measure effectiveness.
